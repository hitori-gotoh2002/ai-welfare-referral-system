...
| 3. AI/Recommendation & Safety | Gemini 프롬프트, 추천 로직, 안전장치 | `backend_server.py`, `age-filter-patch.js`, 향후 `ai/`, `recommendation/`, `safety/` |
...
- `python -m py_compile backend_server.py`가 통과합니다.
